...
- Backoffice assets are served from `App_Plugins` (`fc-aeo`, `fc-foundation`) and built for the Umbraco Bellissima backoffice. AEO's configuration views live under **Settings → Flowcourier**. Its two analytics views, **AI Crawlers** and **AI Referrals**, live there too on a site running AEO alone, and move into the **Analytics** section when [Flowcourier Analytics](/docs/analytics/start-here/get-started/) is installed.
