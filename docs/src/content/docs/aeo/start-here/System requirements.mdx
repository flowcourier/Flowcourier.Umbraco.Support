...
- Backoffice assets are served from `App_Plugins` (`fc-aeo`, `fc-foundation`) and built for the Umbraco Bellissima backoffice. AEO's configuration views live under **Settings → Flowcourier**. Its analytics view, **AI Traffic** (AI crawlers and AI referrals, four tabs), lives there too on a site running AEO alone, and moves into the **Analytics** section when [Flowcourier Analytics](/docs/analytics/start-here/get-started/) is installed.
