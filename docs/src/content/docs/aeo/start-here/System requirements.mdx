...
The package major version tracks the Umbraco major version (17.x targets Umbraco 17). AEO is currently in **prerelease** (17.0.0-alpha), so install with the `--prerelease` flag.
