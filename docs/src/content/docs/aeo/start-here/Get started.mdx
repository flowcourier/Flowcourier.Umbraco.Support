...
Unlike the Flowcourier AI agents, AEO has **no AI dependency at all** — no Umbraco AI, no LLM provider, no API key. Everything is generated from your own published content.
...
1. Install the package
    ...
    <Code code="dotnet add package Flowcourier.Umbraco.AEO --prerelease" lang="shell" />

    AEO is currently in prerelease (17.0.0-alpha), hence the `--prerelease` flag.
