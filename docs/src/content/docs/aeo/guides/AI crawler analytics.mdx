...
## The AI Crawlers view

Open **Analytics → AI Crawlers** in the backoffice. With [Flowcourier Analytics](/docs/analytics/start-here/get-started/) installed this view is a tab in the **Analytics** section; on a site running AEO alone it is under **Settings → Flowcourier → AEO Dashboard**.
