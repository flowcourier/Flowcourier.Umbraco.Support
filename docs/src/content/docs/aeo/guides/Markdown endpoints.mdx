...
:::note
Culture-prefixed **`llms.txt` / `llms-full.txt`** URLs support a single path segment (`/es/`, `/de-at/`). Host-based domains have no such limit. `.md` pages work at any depth. (Multi-segment domain prefixes for the two text endpoints aren't routed.)
:::
