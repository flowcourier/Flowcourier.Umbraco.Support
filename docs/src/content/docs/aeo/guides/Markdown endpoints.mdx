...
Open any document, switch to **Analytics → AI Traffic**, and press **Compare Human vs AI view**. The page opens as a browser downloads it beside the page as an AI client is served it, with what each costs to read:
