...
The `Schema` and `CrawlerAnalytics` sub-sections have their own reference tables in the [Structured data](/docs/aeo/guides/structured-data/#appsettings-reference) and [AI crawler analytics](/docs/aeo/guides/ai-crawler-analytics/#appsettings-reference) guides.
