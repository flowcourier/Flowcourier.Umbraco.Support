...
6. Try the agents
    ...
    ![A content page with the Umbraco Copilot open, showing the Translation Agent's Translate to… starter](../../../../assets/ai/translation-agent/start-translation-agent.png)
