...
3. Install the agents you need
    ...
    Want everything? The [Flowcourier.Umbraco.AI](https://www.nuget.org/packages/Flowcourier.Umbraco.AI/) meta-package installs all available agents in one go:

    <Code code="dotnet add package Flowcourier.Umbraco.AI" lang="shell" />
...
6. Try the agents
    ...
    Open a content page and launch the **Copilot**. On a culture-varying page, pick the **Translation Agent** and use the **Translate…** starter (or the **Translate…** button in the workspace footer), choose the target language and confirm with **Start translation**. On any page, ask the **SEO Agent** to suggest SEO fields — suggestions are staged into the editor for you to review and save.

    ![A content page with the Umbraco Copilot open, showing the Translation Agent's Translate… starter](../../../../assets/ai/translation-agent/start-translation-agent.png)

    Prefer to watch? The [quick demo](https://www.youtube.com/watch?v=Im_ZgUiSLm4) walks through a translation from start to approval in seven minutes.
...
- See what a [Translation Pro](/docs/ai/guides/translation-pro/) license adds — multi-page and entire-site batch translation, the Azure Translator engine (100+ languages) and an enforced termbase.
