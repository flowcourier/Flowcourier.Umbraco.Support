...
[Quick demo of the Translation Agent](https://www.youtube.com/watch?v=RGpStzy3BLU) (7 min) — translating a page, sending it for approval, and the reviewer approving it.
:::
...
3. Confirm with **Start translation**.
    ...
    ![The Copilot confirming the language pair, with a Start translation button and an optional Select pages action](../../../../assets/ai/translation-agent/start-translation.png)
...
![The Translation Agent view with content and dictionary actions on the left and License, Engine, Workflow and Termbase status cards on the right](../../../../assets/ai/translation-agent/translation-agent-dashboard.png)

The **Content** card translates pages from the view itself; without a [Translation Pro](/docs/ai/guides/translation-pro/) license the language buttons are disabled there, since single pages are always translated free from the page editor's Copilot.

### Dictionary items

The same view also translates **dictionary items** — free in every edition. Use *Translate dictionary items…*, pick the items from the dictionary tree, pick the target language, and the default-language values are translated and saved. Existing target values for the picked items are overwritten; an item whose translation fails is left untouched (dictionary lookups fall back to the default language at runtime anyway). On licensed installs [termbase](/docs/ai/guides/translation-pro/) terms are enforced, same as for content.
...
![The send-for-approval card in the Copilot with the reviewer picker open, listing matching backoffice users](../../../../assets/ai/translation-agent/send-for-approval.png)
...
![The Translation Workflow dashboard listing pending and approved reviews with their culture, reviewer, age and actions](../../../../assets/ai/translation-agent/translation-workflow-view.png)
...
Everything on this page is free, including commercial production use. A [Translation Pro](/docs/ai/guides/translation-pro/) license unlocks more inside the same package:
