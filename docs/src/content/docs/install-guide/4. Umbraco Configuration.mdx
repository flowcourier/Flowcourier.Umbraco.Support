...
* **Service Account Credentials**: Paste here JSON key of the Service Account. See [section 3.5](#35--open-json-key-and-paste-it-to-umbraco-back-office) below for details on how to get this.
...
#### 3.5  Open JSON Key and paste it to Umbraco back-office
Open the downloaded JSON key file (in text editor) and copy the entire key to the Service Account Credentials field in the Umbraco back-office. It should look like this:
...
Finally, the configuration should look like this screenshot below:
